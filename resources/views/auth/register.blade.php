                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="territory" class="form-control @error('territory') is-invalid @enderror" name="territory" value="{{ old('territory') }}" required autocomplete="territory" autofocus>
